      ...
      <div className="max-w-3xl mx-auto px-6">
        <GlassCard className="text-center p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
                <div className="w-20 h-20 mx-auto bg-gradient-to-br from-brand-electric to-purple-600 rounded-full flex items-center justify-center mb-6 shadow-xl">
                    <Code className="text-white w-10 h-10" />
                </div>
                <h2 className="text-2xl font-bold text-white mb-2">Built by Abdellatif Choukri</h2>
                <p className="text-white/60 mb-8">Full-stack developer passionate about privacy-first messaging.</p>
                
                <div className="flex justify-center gap-6">
                    <a href="mailto:choukric148@gmail.com" className="flex flex-col items-center gap-2 group">
                        <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-brand-electric group-hover:text-white transition-all duration-300">
                            <Mail size={20} />
                        </div>
